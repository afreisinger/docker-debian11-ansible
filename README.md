# Debian 11 (Bulleye) Ansible Test Image

[![Build](https://github.com/afreisinger/docker-debian11-ansible/actions/workflows/build.yml/badge.svg)](https://github.com/afreisinger/docker-debian11-ansible/actions/workflows/build.yml) [![Docker pulls](https://img.shields.io/docker/pulls/afreisinger/docker-debian11-ansible)](https://hub.docker.com/r/afreisinger/docker-debian11-ansible/)
...
## How to Use
  ...
  2. Pull this image from Docker Hub: `docker pull afreisinger/docker-debian11-ansible:latest` (or use the image you built earlier, e.g. `debian11-ansible:latest`).
